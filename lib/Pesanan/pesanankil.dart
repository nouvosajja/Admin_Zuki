...
class Pesanan_kilat extends StatefulWidget {
  const Pesanan_kilat({Key? key});

  @override
  State<Pesanan_kilat> createState() => _Pesanan_kilatState();
}

class _Pesanan_kilatState extends State<Pesanan_kilat> {
            ...
            Container(
              ...
              child: ListView.builder(
                itemCount: getorder_api?.transactions
                        ?.where((transaction) => transaction.paketId == "2")
                        .toList()
                        .length ??
                    0,
                shrinkWrap: true,
